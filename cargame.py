...
while not quit_game:
    ...
    cars1 = cars(110,40, 2, "Green Car", 10)
    cars2 = cars(260, 40, 3, "Blue Car", 10)
    cars3 = cars(410,40, 4, "Orange Car", 10)
    cars4 = cars(560,40, 5, "Purple Car", 10)
    cars5 = cars(-100,0, 6, "Sky Car", 10)
